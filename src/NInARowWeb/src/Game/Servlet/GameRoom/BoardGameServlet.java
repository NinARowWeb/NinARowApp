...
public class BoardGameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Gson gson = new Gson();
        String jsonResponse = gson.toJson(new BoardGameContentResponse(game.getBoard(),game.getRows(),game.getCols(),game.getVarient(),game.isActiveGame()? "Yes" : "No",game.getStatus(),game.getWinnersCoordinates()));
