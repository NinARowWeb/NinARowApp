...
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print(ErrorUtils.getErrorLoginMessage());
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameFromSession == null) {
            ...
            if (usernameFromParameter == null || usernameFromParameter == "") {
                ErrorUtils.setErrorLoginMessage(new Error("You need to insert a name"));
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        ...
                        ErrorUtils.setErrorLoginMessage(new Error(errorMessage));
                        ...
                        userManager.addUser(usernameFromParameter,computer);
